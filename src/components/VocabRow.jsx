...
const VocabRow = ({ id, text, pinyin, difficulty, definition, similar, label, expression, sentence, pinned }) => {
        ...
        if (matches[index]) {
          ...
          acc.push(
            <span key={`match-${index}`}
              style={{ color: mode === "light" ? theme.palette.neutral.mid : theme.palette.primary.dark }}
            >
              {matches[index]}
            </span>
          );
